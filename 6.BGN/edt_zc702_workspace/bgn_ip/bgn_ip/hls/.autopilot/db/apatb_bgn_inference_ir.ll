; ModuleID = 'E:/FPGA/2024/MicroPhase-Z7-Lite-Board/BGN/edt_zc702_workspace/bgn_ip/bgn_ip/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %dst.addr.0.0.06 = getelementptr [25 x %"struct.ap_uint<32>"], [25 x %"struct.ap_uint<32>"]* %dst, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
  %1 = load i32, i32* %src.addr.0.0.05, align 4
  store i32 %1, i32* %dst.addr.0.0.06, align 4
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
