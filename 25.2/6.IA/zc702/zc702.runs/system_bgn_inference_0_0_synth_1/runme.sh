...
HD_PWD='C:/source/.ITA/FPGA/25.2/6.IA/zc702/zc702.runs/system_bgn_inference_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_bgn_inference_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_bgn_inference_0_0.tcl
