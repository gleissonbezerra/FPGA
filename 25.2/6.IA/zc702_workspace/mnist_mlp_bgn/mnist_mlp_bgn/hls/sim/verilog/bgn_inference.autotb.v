...
`define AUTOTB_DUT      bgn_inference
`define AUTOTB_DUT_INST AESL_inst_bgn_inference
`define AUTOTB_TOP      apatb_bgn_inference_top
`define AUTOTB_LAT_RESULT_FILE "bgn_inference.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "bgn_inference.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_bgn_inference_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_input_img 1
`define AESL_DEPTH_prediction 1
`define AUTOTB_TVIN_input_img  "../tv/cdatafile/c.bgn_inference.autotvin_input_img.dat"
`define AUTOTB_TVIN_input_img_out_wrapc  "../tv/rtldatafile/rtl.bgn_inference.autotvin_input_img.dat"
`define AUTOTB_TVOUT_prediction  "../tv/cdatafile/c.bgn_inference.autotvout_prediction.dat"
`define AUTOTB_TVOUT_prediction_out_wrapc  "../tv/rtldatafile/rtl.bgn_inference.autotvout_prediction.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 22427;
parameter LENGTH_input_img = 25;
parameter LENGTH_prediction = 1;
