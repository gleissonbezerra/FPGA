...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ system_bgn_inference_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "system_bgn_inference_0_0,bgn_inference,{}" *) (* CORE_GENERATION_INFO = "system_bgn_inference_0_0,bgn_inference,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=bgn_inference,x_ipVersion=1.0,x_ipCoreRevision=2114498125,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CTRL_ADDR_WIDTH=8,C_S_AXI_CTRL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
