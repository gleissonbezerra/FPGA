...
set C_modelArgList {
	...
	{ weight_mem int 64 regular {axi_slave 0}  }
	{ range_size int 32 regular {axi_slave 0}  }
	{ intensity int 32 regular {axi_slave 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "weight_mem","offset": { "type": "dynamic","port_name": "weight_mem","bundle": "control_r"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "weight_mem", "interface" : "axi_slave", "bundle":"control_r","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "range_size", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "intensity", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	{ "Name" : "seed", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":32}, "offset_end" : {"in":39}} ]}
...
set NewPortList {[ 
	...
	{ "name": "s_axi_control_r_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "control_r", "role": "AWADDR" },"address":[{"name":"weight_mem","role":"data","value":"16"}] },
...
set ArgLastReadFirstWriteLatency {
	radiation_injector {
		gmem {Type IO LastRead 83 FirstWrite 82}
		weight_mem {Type I LastRead 0 FirstWrite -1}
		range_size {Type I LastRead 0 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "37", "Max" : "87"}
	, {"Name" : "Interval", "Min" : "38", "Max" : "88"}
]}
