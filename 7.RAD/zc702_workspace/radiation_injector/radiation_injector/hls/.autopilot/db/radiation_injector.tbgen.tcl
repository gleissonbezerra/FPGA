...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "weight_mem","offset": { "type": "dynamic","port_name": "weight_mem","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "wr_addr", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":35}} , 
 	{ "Name" : "wr_data", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":36}, "offset_end" : {"in":43}} ]}
...
set ArgLastReadFirstWriteLatency {
	radiation_injector {
		gmem0 {Type IO LastRead 12 FirstWrite 11}
