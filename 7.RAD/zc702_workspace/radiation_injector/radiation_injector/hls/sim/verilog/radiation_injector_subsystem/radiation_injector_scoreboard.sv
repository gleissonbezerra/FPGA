...
//
//==============================================================
`ifndef RADIATION_INJECTOR_SCOREBOARD__SV                                                       
    `define RADIATION_INJECTOR_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class radiation_injector_scoreboard extends uvm_component;                                        
                                                                                               
        radiation_injector_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(radiation_injector_scoreboard)                                     
        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            fork                                                                               
                ...
                forever begin
                    @refm.allaxilite_write_data_finish;
                    `uvm_info(this.get_full_name(), "receive allaxilite_write_finish axilite write_mem_page_process", UVM_LOW)
                    void'(refm.mem_blk_pages_control_range_size.pages.pop_front());
                    void'(refm.mem_blk_pages_control_intensity.pages.pop_front());
                    void'(refm.mem_blk_pages_control_seed.pages.pop_front());
                end
