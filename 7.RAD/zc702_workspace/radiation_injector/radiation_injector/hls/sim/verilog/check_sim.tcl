...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.radiation_injector.autotvin_gmem.dat"
         "c.radiation_injector.autotvin_weight_mem.dat"
         "c.radiation_injector.autotvin_range_size.dat"
         "c.radiation_injector.autotvin_intensity.dat"
         "c.radiation_injector.autotvin_seed.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.radiation_injector.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
