...
if {[file isfile radiation_injector.autotvin.dat]} {
	file delete -force radiation_injector.autotvin.dat
}

if {[file isfile radiation_injector.autotvout.dat]} {
	file delete -force radiation_injector.autotvout.dat
}
