...
TOOLCHAIN += --sysroot=D:/AMDDesignTools/2025.2/Vitis/tps/mingw/10.0.0/win64.o/nt
...
$(ObjDir)/test_bench.cpp_pre.cpp.tb.o : test_bench.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test_bench.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/radiation_injector.cpp_pre.cpp.tb.o : radiation_injector.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling radiation_injector.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
