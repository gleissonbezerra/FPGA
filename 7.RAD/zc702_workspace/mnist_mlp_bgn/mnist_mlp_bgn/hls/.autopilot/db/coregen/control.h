...
#define CONTROL_ADDR_PREDICTION_CTRL 0x20
#define CONTROL_ADDR_INPUT_IMG_BASE  0x80
#define CONTROL_ADDR_INPUT_IMG_HIGH  0xff
#define CONTROL_WIDTH_INPUT_IMG      32
#define CONTROL_DEPTH_INPUT_IMG      25
