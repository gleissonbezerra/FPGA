...
if {[file isfile bgn_inference.autotvin.dat]} {
	file delete -force bgn_inference.autotvin.dat
}

if {[file isfile bgn_inference.autotvout.dat]} {
	file delete -force bgn_inference.autotvout.dat
}
