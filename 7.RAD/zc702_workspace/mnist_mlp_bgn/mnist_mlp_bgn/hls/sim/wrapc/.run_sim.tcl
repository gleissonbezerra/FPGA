...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "bgn_inference.autotvin.dat"
	set constFileTvOut       "bgn_inference.autotvout.dat"
	set constFileHdlTvIn     "bgn_inference.autohdltvin.dat"
	set constFileHdlTvOut    "bgn_inference.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
