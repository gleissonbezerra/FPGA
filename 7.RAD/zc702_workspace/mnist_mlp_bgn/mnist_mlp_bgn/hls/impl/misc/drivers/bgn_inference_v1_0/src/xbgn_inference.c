...
void XBgn_inference_Start(XBgn_inference *InstancePtr) {
    ...
    Data = XBgn_inference_ReadReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_AP_CTRL) & 0x80;
    XBgn_inference_WriteReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_AP_CTRL, Data | 0x01);
}
...
u32 XBgn_inference_IsDone(XBgn_inference *InstancePtr) {
    ...
    Data = XBgn_inference_ReadReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_AP_CTRL);
    return (Data >> 1) & 0x1;
}
...
void XBgn_inference_EnableAutoRestart(XBgn_inference *InstancePtr) {
    ...
    XBgn_inference_WriteReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_AP_CTRL, 0x80);
}
...
void XBgn_inference_DisableAutoRestart(XBgn_inference *InstancePtr) {
    ...
    XBgn_inference_WriteReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_AP_CTRL, 0);
}
...
u32 XBgn_inference_Get_prediction(XBgn_inference *InstancePtr) {
    ...
    Data = XBgn_inference_ReadReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_PREDICTION_DATA);
    return Data;
}
...
u32 XBgn_inference_Get_prediction_vld(XBgn_inference *InstancePtr) {
    ...
    Data = XBgn_inference_ReadReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_PREDICTION_CTRL);
    return Data & 0x1;
}
...
u32 XBgn_inference_Get_input_img_BaseAddress(XBgn_inference *InstancePtr) {
    ...
    return (InstancePtr->Ctrl_BaseAddress + XBGN_INFERENCE_CTRL_ADDR_INPUT_IMG_BASE);
}
...
u32 XBgn_inference_Get_input_img_HighAddress(XBgn_inference *InstancePtr) {
    ...
    return (InstancePtr->Ctrl_BaseAddress + XBGN_INFERENCE_CTRL_ADDR_INPUT_IMG_HIGH);
}
...
u32 XBgn_inference_Get_input_img_TotalBytes(XBgn_inference *InstancePtr) {
    ...
    return (XBGN_INFERENCE_CTRL_ADDR_INPUT_IMG_HIGH - XBGN_INFERENCE_CTRL_ADDR_INPUT_IMG_BASE + 1);
}
...
u32 XBgn_inference_Get_input_img_BitWidth(XBgn_inference *InstancePtr) {
    ...
    return XBGN_INFERENCE_CTRL_WIDTH_INPUT_IMG;
}
...
u32 XBgn_inference_Get_input_img_Depth(XBgn_inference *InstancePtr) {
    ...
    return XBGN_INFERENCE_CTRL_DEPTH_INPUT_IMG;
}
...
u32 XBgn_inference_Write_input_img_Words(XBgn_inference *InstancePtr, int offset, word_type *data, int length) {
    ...
    if ((offset + length)*4 > (XBGN_INFERENCE_CTRL_ADDR_INPUT_IMG_HIGH - XBGN_INFERENCE_CTRL_ADDR_INPUT_IMG_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Ctrl_BaseAddress + XBGN_INFERENCE_CTRL_ADDR_INPUT_IMG_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XBgn_inference_Read_input_img_Words(XBgn_inference *InstancePtr, int offset, word_type *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Ctrl_BaseAddress + XBGN_INFERENCE_CTRL_ADDR_INPUT_IMG_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XBgn_inference_Write_input_img_Bytes(XBgn_inference *InstancePtr, int offset, char *data, int length) {
    ...
    if ((offset + length) > (XBGN_INFERENCE_CTRL_ADDR_INPUT_IMG_HIGH - XBGN_INFERENCE_CTRL_ADDR_INPUT_IMG_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Ctrl_BaseAddress + XBGN_INFERENCE_CTRL_ADDR_INPUT_IMG_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XBgn_inference_Read_input_img_Bytes(XBgn_inference *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Ctrl_BaseAddress + XBGN_INFERENCE_CTRL_ADDR_INPUT_IMG_BASE + offset + i);
    }
    return length;
}
...
void XBgn_inference_InterruptGlobalEnable(XBgn_inference *InstancePtr) {
    ...
    XBgn_inference_WriteReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_GIE, 1);
}
...
void XBgn_inference_InterruptGlobalDisable(XBgn_inference *InstancePtr) {
    ...
    XBgn_inference_WriteReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_GIE, 0);
}
...
void XBgn_inference_InterruptEnable(XBgn_inference *InstancePtr, u32 Mask) {
    ...
    Register =  XBgn_inference_ReadReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_IER);
    XBgn_inference_WriteReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_IER, Register | Mask);
}
...
void XBgn_inference_InterruptClear(XBgn_inference *InstancePtr, u32 Mask) {
    ...
    XBgn_inference_WriteReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_ISR, Mask);
}
...
u32 XBgn_inference_InterruptGetEnabled(XBgn_inference *InstancePtr) {
    ...
    return XBgn_inference_ReadReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_IER);
}
...
u32 XBgn_inference_InterruptGetStatus(XBgn_inference *InstancePtr) {
    ...
    return XBgn_inference_ReadReg(InstancePtr->Ctrl_BaseAddress, XBGN_INFERENCE_CTRL_ADDR_ISR);
}
