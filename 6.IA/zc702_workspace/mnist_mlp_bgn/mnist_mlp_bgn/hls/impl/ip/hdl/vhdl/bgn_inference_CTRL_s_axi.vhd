...
entity bgn_inference_CTRL_s_axi is
generic (
...
end entity bgn_inference_CTRL_s_axi;
...
architecture behave of bgn_inference_CTRL_s_axi is
...
attribute DowngradeIPIdentifiedWarnings of behave : architecture is "yes";
    ...
    component bgn_inference_CTRL_s_axi_ram is
        generic (
    ...
    end component bgn_inference_CTRL_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_input_img
int_input_img : bgn_inference_CTRL_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "2P",
     BYTE_WIDTH => 8,
...
entity bgn_inference_CTRL_s_axi_ram is
    generic (
        MEM_STYLE  : STRING :="auto";
        MEM_TYPE   : STRING :="S2P";
        BYTE_WIDTH : INTEGER :=8;
...
end entity bgn_inference_CTRL_s_axi_ram;

architecture behave of bgn_inference_CTRL_s_axi_ram is
