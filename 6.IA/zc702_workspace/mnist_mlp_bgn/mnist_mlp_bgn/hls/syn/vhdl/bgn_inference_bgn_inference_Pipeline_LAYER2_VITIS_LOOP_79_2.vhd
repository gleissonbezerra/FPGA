...
attribute shreg_extract : string;
    ...
    signal icmp_ln90_fu_371_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln90_fu_385_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    class_idx_1_fu_388_p3 <= 
        zext_ln90_fu_385_p1 when (icmp_ln90_fu_371_p2(0) = '1') else 
    ...
    icmp_ln90_fu_371_p2 <= "1" when (signed(sext_ln86_2_fu_367_p1) > signed(select_ln75_2_fu_337_p3)) else "0";
    max_score_1_fu_377_p3 <= 
        sext_ln86_2_fu_367_p1 when (icmp_ln90_fu_371_p2(0) = '1') else 
    ...
    zext_ln90_fu_385_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln75_reg_506_pp0_iter4_reg),32));
end behav;
