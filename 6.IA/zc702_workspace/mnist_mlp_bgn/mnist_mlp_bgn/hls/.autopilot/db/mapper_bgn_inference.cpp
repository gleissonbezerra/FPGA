...
using hls::sim::Byte;
extern "C" void bgn_inference(Byte<4>*, volatile void *);
extern "C" void apatb_bgn_inference_hw(volatile void * __xlx_apatb_param_input_img, volatile void * __xlx_apatb_param_prediction) {
...
__xlx_input_img__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_img)[i]);
  ...
  // DUT call
  bgn_inference(__xlx_input_img__tmp_vec.data(), __xlx_apatb_param_prediction);
