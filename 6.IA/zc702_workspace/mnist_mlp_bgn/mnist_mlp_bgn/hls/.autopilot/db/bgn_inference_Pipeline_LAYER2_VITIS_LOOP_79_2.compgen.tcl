...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bgn_inference_bgn_inference_Pipeline_LAYER2_VITIS_LOOP_79_2_weights_l2_ROM_1P_BRAM_1R BINDTYPE {storage} TYPE {rom_1p} IMPL {bram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bgn_inference_bgn_inference_Pipeline_LAYER2_VITIS_LOOP_79_2_bias_l2_ROM_1P_BRAM_1R BINDTYPE {storage} TYPE {rom_1p} IMPL {bram} LATENCY 2 ALLOW_PRAGMA 1
}
